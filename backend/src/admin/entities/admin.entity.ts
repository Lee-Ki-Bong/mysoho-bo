...
import { Entity, PrimaryGeneratedColumn, Column, OneToOne, OneToMany, AfterLoad } from 'typeorm';
...
export class Admin {
  ...
  @AfterLoad()
  setRegistrationType() {
    this.registrationType = this.adminSns && this.adminSns.length > 0 ? 'SNS' : 'NORMAL';
  }
}
